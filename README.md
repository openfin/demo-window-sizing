...
Windows installer [here](https://dl.openfin.co/services/download?fileName=demo-frameless-window&config=http://openfin.github.io/demo-window-sizing/src/app.json)